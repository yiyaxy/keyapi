...
func InitEnv() {
	...
	SiteLabel = GetEnvOrDefaultString("SITE_LABEL", "DEV")
	PrometheusToken = os.Getenv("PROMETHEUS_TOKEN")
	AnalyticsTZOffset = GetEnvOrDefault("ANALYTICS_TZ_OFFSET", 0)
...
func initConstantEnv() {
	...
	constant.NotificationLimitDurationMinute = GetEnvOrDefault("NOTIFICATION_LIMIT_DURATION_MINUTE", 1440)
