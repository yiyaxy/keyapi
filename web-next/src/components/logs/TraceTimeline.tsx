...
const PHASE_COLOR: Record<string, string> = {
  ...
  upstream_request: 'text-orange-600 dark:text-orange-400',
  upstream_headers: 'text-orange-600 dark:text-orange-400',
  upstream_response: 'text-orange-700 dark:text-orange-300',
