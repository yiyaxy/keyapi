...
describe('normalizeBotReplyLocale', () => {
  ...
  it('normalizes Telegram-style lowercase to project Locales', () => {
    expect(normalizeBotReplyLocale('pt-br')).toBe('zh-CN');
  ...
  it('falls back to zh-CN when the input is not a project locale', () => {
...
describe('getBotReplyLocale', () => {
  ...
  it('falls back to zh-CN for unknown or missing platforms', () => {
