    ...
    <scroll-view scroll-y class="scroll" :style="scrollOffsetStyle">
      ...
      <view class="menu-card">
        <view class="menu-item" @click="nav('/pages/apikey/index')">
          <view class="menu-left">
            <view class="menu-icon" style="background:#eef1ff;">
              <u-icon name="setting" size="20" color="#4F6EF7" />
            </view>
        ...
        <view class="menu-item" @click="nav('/pages/orders/index')">
          <view class="menu-left">
            <view class="menu-icon" style="background:#e8faf0;">
              <u-icon name="order" size="20" color="#18A058" />
            </view>
        ...
        <view class="menu-item" @click="nav('/pages/usage-records/index')">
          <view class="menu-left">
            <view class="menu-icon" style="background:#fff7e8;">
              <u-icon name="clock" size="20" color="#f59e0b" />
            </view>
        ...
        <view class="menu-item" @click="nav('/pages/redeem/index')">
          <view class="menu-left">
            <view class="menu-icon" style="background:#e8faf0;">
              <u-icon name="coupon" size="20" color="#18A058" />
            </view>
        ...
        <view class="menu-item" @click="nav('/pages/invite/index')">
          <view class="menu-left">
            <view class="menu-icon" style="background:#ffeef2;">
              <u-icon name="share" size="20" color="#ef4444" />
            </view>
            <view>
              <text class="menu-label">我的下级</text>
              <text class="menu-sub">查看拉新数据并分享小程序</text>
            </view>
          </view>
          <u-icon name="arrow-right" size="15" color="#9ca3af" />
        </view>
      ...
      <view class="info-card">
        ...
        <view class="info-div" />
        <view class="info-row">
          <text class="info-key">用户等级</text>
          <text class="info-val">{{ levelName }}</text>
        </view>
        <view class="info-div" />
        <view class="info-row">
      ...
      <view class="logout-btn" @click="doLogout">
        <u-icon name="logout" size="18" color="#ef4444" />
...
.user-meta-row { display: flex; align-items: center; flex-wrap: wrap; gap: 10rpx; }
