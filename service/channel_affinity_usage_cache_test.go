...
func uniqueChannelAffinityUsageCacheTestKey(t *testing.T, prefix string) string {
	t.Helper()
	return fmt.Sprintf("%s:%s:%d", prefix, t.Name(), channelAffinityUsageCacheTestSeq.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	...
	usingGroup := "default"
	keyFP := uniqueChannelAffinityUsageCacheTestKey(t, "fp")
