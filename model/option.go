...
func InitOptionMap() {
	...
	common.OptionMap["WxMiniAuthEnabled"] = strconv.FormatBool(common.WxMiniAuthEnabled)
	...
	common.OptionMap["WxMiniAppId"] = ""
	common.OptionMap["WxMiniAppSecret"] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "WxMiniAuthEnabled":
			common.WxMiniAuthEnabled = boolValue
	...
	case "WxMiniAppId":
		common.WxMiniAppId = value
	case "WxMiniAppSecret":
		common.WxMiniAppSecret = value
