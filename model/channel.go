...
type Channel struct {
	...
	MaxRetry          *int    `json:"max_retry" gorm:"default:0"`
	...
	MarkupRatio       *float64 `json:"markup_ratio" gorm:"default:null"`
	PlatformCostRatio *float64 `json:"platform_cost_ratio" gorm:"default:null"`
...
func (c *Channel) GetMaxRetry() int {
	if c.MaxRetry == nil {
		return 0
	}
	return *c.MaxRetry
