...
const TopUp = () => {
  ...
  const [enableOnlineTopUp, setEnableOnlineTopUp] = useState(null);
  ...
  const getTopupInfo = async () => {
    try {
      ...
      if (success) {
        // 最先设置充值开关，确保不被内层异常影响
        const enableOnline = !!data.enable_online_topup;
        console.log('[DEBUG topup] enable_online_topup =', data.enable_online_topup, '| enableOnline =', enableOnline);
        setEnableOnlineTopUp(enableOnline);

        const minTopUpValue = enableOnline ? data.min_topup : 1;
    ...
    <div className='w-full max-w-7xl mx-auto relative min-h-screen lg:min-h-0 mt-[60px] px-2'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <RechargeCard
          ...
          userState={userState}
          renderQuota={renderQuota}
          statusLoading={enableOnlineTopUp === null}
          topupInfo={topupInfo}
