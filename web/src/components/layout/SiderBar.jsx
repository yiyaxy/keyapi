...
const routerMap = {
  ...
  tenantPlan: '/console/tenant-plan',
  tenantConfig: '/console/tenant-config',
  tenantDashboard: '/console/tenant-dashboard',
...
const SiderBar = ({ onNavigate = () => {} }) => {
  ...
  const adminItems = useMemo(() => {
    const items = [
      ...
      {
        text: t('租户配置'),
        itemKey: 'tenantConfig',
        to: '/tenant-config',
        className: isAdmin() ? '' : 'tableHiddle',
      },
      {
        text: t('租户仪表盘'),
        itemKey: 'tenantDashboard',
        to: '/tenant-dashboard',
        className: isAdmin() ? '' : 'tableHiddle',
      },
      {
        text: t('租户告警'),
        itemKey: 'tenantAlerts',
        to: '/tenant-alerts',
        className: isAdmin() ? '' : 'tableHiddle',
      },
      {
