...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.TenantAPIRateLimit())
	{
		...
		appPublicRoute := apiRouter.Group("/app")
		{
			...
			appPublicRoute.POST("/image-uploads", middleware.UserAuth(), app.UploadAppImages)
			appPublicRoute.POST("/image-uploads/presign", middleware.UserAuth(), app.PresignAppImageUpload)
			appPublicRoute.POST("/image-uploads/presign-batch", middleware.UserAuth(), app.PresignAppImageUploadBatch)
